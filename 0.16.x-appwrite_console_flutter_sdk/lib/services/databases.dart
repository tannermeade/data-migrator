...
class Databases extends Service {
    ...
    /// Get usage stats for the database
     Future<models.UsageDatabases> getUsage({String? range}) async {
    ...
    ///
     Future<models.LogList> listDocumentLogs({required String databaseId, required String collectionId, required String documentId, List<String>? queries}) async {
        final String path = '/databases/{databaseId}/collections/{collectionId}/documents/{documentId}/logs'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId).replaceAll('{documentId}', documentId);
    ...
    ///
     Future<models.LogList> listCollectionLogs({required String databaseId, required String collectionId, List<String>? queries}) async {
        final String path = '/databases/{databaseId}/collections/{collectionId}/logs'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
    ...
    /// Get usage stats for a collection
     Future<models.UsageCollection> getCollectionUsage({required String databaseId, required String collectionId, String? range}) async {
        final String path = '/databases/{databaseId}/collections/{collectionId}/usage'.replaceAll('{databaseId}', databaseId).replaceAll('{collectionId}', collectionId);
    ...
    ///
     Future<models.LogList> listLogs({required String databaseId, List<String>? queries}) async {
        final String path = '/databases/{databaseId}/logs'.replaceAll('{databaseId}', databaseId);
    ...
    /// Get usage stats for the database
     Future<models.UsageDatabase> getDatabaseUsage({required String databaseId, String? range}) async {
        final String path = '/databases/{databaseId}/usage'.replaceAll('{databaseId}', databaseId);
