...
class Functions extends Service {
  ...
  ///
  Future<models.Funct> create(
      {required String functionId,
      required String name,
      required List<String> execute,
    ...
    return models.Funct.fromMap(res.data);
  }
  ...
  /// Get Functions Usage
  Future<models.UsageFunctions> getUsage({String? range}) async {
    const String path = '/functions/usage';
  ...
  ///
  Future<models.Funct> get({required String functionId}) async {
  ...
  Future<models.DeploymentList> listDeployments(
      {required String functionId, List<String>? queries, String? search}) async {
  ...
  Future<models.Deployment> getDeployment({required String functionId, required String deploymentId}) async {
    final String path = '/functions/{functionId}/deployments/{deploymentId}'
  ...
  /// execution endpoint.
  ///
  Future<models.Funct> updateDeployment({required String functionId, required String deploymentId}) async {
    final String path = '/functions/{functionId}/deployments/{deploymentId}'
        .replaceAll('{functionId}', functionId)
        .replaceAll('{deploymentId}', deploymentId);
  ...
  Future retryBuild({required String functionId, required String deploymentId, required String buildId}) async {
    final String path = '/functions/{functionId}/deployments/{deploymentId}/builds/{buildId}'
        .replaceAll('{functionId}', functionId)
        .replaceAll('{deploymentId}', deploymentId)
  ...
  /// Get Function Usage
  Future<models.UsageFunctions> getFunctionUsage({required String functionId, String? range}) async {
    final String path = '/functions/{functionId}/usage'.replaceAll('{functionId}', functionId);
  ...
  Future<models.Variable> createVariable(
      {required String functionId, required String key, required String value}) async {
    final String path = '/functions/{functionId}/variables'.replaceAll('{functionId}', functionId);
  ...
  Future<models.Variable> getVariable({required String functionId, required String variableId}) async {
    final String path = '/functions/{functionId}/variables/{variableId}'
        .replaceAll('{functionId}', functionId)
  ...
  Future<models.Variable> updateVariable(
      {required String functionId, required String variableId, required String key, String? value}) async {
    final String path = '/functions/{functionId}/variables/{variableId}'
        .replaceAll('{functionId}', functionId)
        .replaceAll('{variableId}', variableId);
