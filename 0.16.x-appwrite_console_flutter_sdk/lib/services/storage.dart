...
class Storage extends Service {
    ...
    ///
     Future<models.Bucket> createBucket({required String bucketId, required String name, required bool fileSecurity, List<String>? permissions, bool? enabled, int? maximumFileSize, List<String>? allowedFileExtensions, String? compression, bool? encryption, bool? antivirus}) async {
        const String path = '/storage/buckets';
    ...
    ///
     Future<models.Bucket> updateBucket({required String bucketId, required String name, required bool fileSecurity, List<String>? permissions, bool? enabled, int? maximumFileSize, List<String>? allowedFileExtensions, String? compression, bool? encryption, bool? antivirus}) async {
        final String path = '/storage/buckets/{bucketId}'.replaceAll('{bucketId}', bucketId);
    ...
    /// Get usage stats for a storage bucket
     Future<models.UsageBuckets> getBucketUsage({required String bucketId, String? range}) async {
        final String path = '/storage/{bucketId}/usage'.replaceAll('{bucketId}', bucketId);
