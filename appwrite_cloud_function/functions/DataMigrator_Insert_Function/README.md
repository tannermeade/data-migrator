# DataMigrator Insert Function

To prepare this function for uploading manually cd into the directory and use:
`tar -zcvf code.tar.gz .`
to create the tarball to upload.

The tarball needs to be named `code.tar.gz` in order to be uploaded.
