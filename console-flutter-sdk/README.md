...
![License](https://img.shields.io/github/license/appwrite/sdk-for-console-flutter.svg?style=flat-square)
...
**This SDK is compatible with Appwrite server version 0.12.x. For older versions, please check [previous releases](https://github.com/appwrite/sdk-for-console-flutter/releases).**
