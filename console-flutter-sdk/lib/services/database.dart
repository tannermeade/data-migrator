...
class Database extends Service {
  ...
  Future<models.AttributeBoolean> createBooleanAttribute(
      {required String collectionId, required String key, required bool xrequired, bool? xdefault, bool? array}) async {
    final String path =
        '/database/collections/{collectionId}/attributes/boolean'.replaceAll('{collectionId}', collectionId);
  ...
  Future<models.AttributeEmail> createEmailAttribute(
      ...
      bool? array}) async {
    final String path =
        '/database/collections/{collectionId}/attributes/email'.replaceAll('{collectionId}', collectionId);
  ...
  Future<models.AttributeEnum> createEnumAttribute(
      ...
      bool? array}) async {
    final String path =
        '/database/collections/{collectionId}/attributes/enum'.replaceAll('{collectionId}', collectionId);
  ...
  Future<models.AttributeFloat> createFloatAttribute(
      ...
      bool? array}) async {
    final String path =
        '/database/collections/{collectionId}/attributes/float'.replaceAll('{collectionId}', collectionId);
  ...
  Future<models.AttributeInteger> createIntegerAttribute(
      ...
      int? max,
      int? xdefault,
      bool? array = false}) async {
    final String path =
        '/database/collections/{collectionId}/attributes/integer'.replaceAll('{collectionId}', collectionId);
    ...
    final Map<String, dynamic> params = {
      ...
      'min': min,
      'max': max,
      // right now in Appwrite v0.12.3 integer attributes can't have a default value in console UI
      'default': xdefault,
      'array': array,
    };
  ...
  Future<models.AttributeString> createStringAttribute(
      ...
      bool? array}) async {
    final String path =
        '/database/collections/{collectionId}/attributes/string'.replaceAll('{collectionId}', collectionId);
  ...
  Future<models.AttributeUrl> createUrlAttribute(
      ...
      bool? array}) async {
    final String path =
        '/database/collections/{collectionId}/attributes/url'.replaceAll('{collectionId}', collectionId);
  ...
  Future getAttribute({required String collectionId, required String key}) async {
    final String path = '/database/collections/{collectionId}/attributes/{key}'
  ...
  Future<models.Document> createDocument(
      {required String collectionId, required String documentId, required Map data, List? read, List? write}) async {
    final String path = '/database/collections/{collectionId}/documents'.replaceAll('{collectionId}', collectionId);
  ...
  Future<models.Document> getDocument({required String collectionId, required String documentId}) async {
    final String path = '/database/collections/{collectionId}/documents/{documentId}'
        .replaceAll('{collectionId}', collectionId)
  ...
  ///
  Future<models.LogList> listDocumentLogs(
      {required String collectionId, required String documentId, int? limit, int? offset}) async {
    final String path = '/database/collections/{collectionId}/documents/{documentId}/logs'
        .replaceAll('{collectionId}', collectionId)
        .replaceAll('{documentId}', documentId);
  ...
  Future<models.Index> getIndex({required String collectionId, required String key}) async {
    final String path = '/database/collections/{collectionId}/indexes/{key}'
        .replaceAll('{collectionId}', collectionId)
        .replaceAll('{key}', key);
  ...
  ///
  Future<models.LogList> listCollectionLogs({required String collectionId, int? limit, int? offset}) async {
    final String path = '/database/collections/{collectionId}/logs'.replaceAll('{collectionId}', collectionId);
  ...
  Future<models.UsageCollection> getCollectionUsage({required String collectionId, String? range}) async {
    final String path = '/database/{collectionId}/usage'.replaceAll('{collectionId}', collectionId);
