...
class Database extends Service {
    Database(Client client): super(client);
     ...
     ///
     Future<models.LogList> listDocumentLogs({required String collectionId, required String documentId, int? limit, int? offset}) async {
        final String path = '/database/collections/{collectionId}/documents/{documentId}/logs'.replaceAll('{collectionId}', collectionId).replaceAll('{documentId}', documentId);
