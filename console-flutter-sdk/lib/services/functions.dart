...
class Functions extends Service {
  ...
  /// endpoint.
  ///
  Future<models.Funct> updateTag({required String functionId, required String tag}) async {
  ...
  /// filter your results.
  ///
  Future<models.TagList> listTags(
      {required String functionId,
      String? search,
      int? limit,
      int? offset,
  ...
  Future<models.Tag> createTag(
      {required String functionId, required String command, required http.MultipartFile code}) async {
    final String path = '/functions/{functionId}/tags'.replaceAll('{functionId}', functionId);
  ...
  Future<models.Tag> getTag({required String functionId, required String tagId}) async {
    final String path =
        '/functions/{functionId}/tags/{tagId}'.replaceAll('{functionId}', functionId).replaceAll('{tagId}', tagId);
  ...
  /// Get Function Usage
  Future<models.UsageFunctions> getUsage({required String functionId, String? range}) async {
