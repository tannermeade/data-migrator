...
class Projects extends Service {
    Projects(Client client): super(client);
     ...
     /// Create Webhook
     Future<models.Webhook> createWebhook({required String projectId, required String name, required List events, required String url, required bool security, String? httpUser, String? httpPass}) async {
        final String path = '/projects/{projectId}/webhooks'.replaceAll('{projectId}', projectId);
     ...
     /// Update Webhook
     Future<models.Webhook> updateWebhook({required String projectId, required String webhookId, required String name, required List events, required String url, required bool security, String? httpUser, String? httpPass}) async {
        final String path = '/projects/{projectId}/webhooks/{webhookId}'.replaceAll('{projectId}', projectId).replaceAll('{webhookId}', webhookId);
